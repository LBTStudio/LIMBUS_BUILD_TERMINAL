(() => {
  ...
  const PersonaDetail = ({ persona, mode, isEquipped, onEquip, onUnequip, onAddRoster, isInRoster }) => {
    if (!persona) {
  ...
  const PersonaCodex = ({ state, dispatch }) => {
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "codex-shell" }, equippedPersona && /* @__PURE__ */ React.createElement(
      EquippedSummary,
      {
        state,
        dispatch,
    ...
    ))), !codexExpanded && equippedPersona && /* @__PURE__ */ React.createElement("div", { className: "codex-collapsed-hint" }, /* @__PURE__ */ React.createElement("span", { style: { color: "var(--tx-mute)", fontSize: "var(--fs-11)", letterSpacing: "0.14em", fontFamily: "var(--f-display)" } }, "\u25C7 \u4EBA\u683C\u4E00\u89A7\u306F\u6298\u308A\u7573\u307F\u4E2D"), /* @__PURE__ */ React.createElement(
      "button",
      {
