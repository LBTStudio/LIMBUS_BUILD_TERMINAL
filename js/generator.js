...
const TIMING_MARKER_WORDS = [
  ...
  "\u30DE\u30C3\u30C1\u6642", "\u30B3\u30B9\u30C8\uFF1A", "\u30B3\u30B9\u30C8:", "\u30B3\u30B9\u30C8",
  /* 原典のコーパスを走査して、段落の先頭に立つ「〜時 / 〜前 / 〜後」を数え、
     語彙に無かったものを補った。件数は core + supplement + pack1 の合計。

       攻撃前 57 / 使用前 26 / 常時 20 / 使用後 9 / クリティカル成功時 6
       被攻撃前 3 / 混乱時 3 / 成功時 3 / 対象討伐時 3 / 攻撃終了時 2
       失敗時 2 / 味方討伐時 2 / マッチ進行時 2
       被ダメージ直前 1 / スキル終了時 1 / 敵討伐失敗時 1

     語彙から漏れていると二つの害がある。
       1. 出力で行が分かれず、前の文と一続きに表示される
       2. 段落監査が「組版から一意に定まらない位置」を判定できず、
          原典が改段しているのに連結を見逃す
          （マッチロック工房フィクサー S4「…（最大1回）敵討伐失敗時：…」）

     長短の語が混在しても、`TIMING_MARKER` は組み立て時に長い語から評価し、
     `TIMING_MARKER_GUARD` が語中一致を禁じるため、並び順に依存しない。 */
  "\u653B\u6483\u524D", "\u4F7F\u7528\u524D", "\u5E38\u6642", "\u4F7F\u7528\u5F8C",
  "\u30AF\u30EA\u30C6\u30A3\u30AB\u30EB\u6210\u529F\u6642", "\u88AB\u653B\u6483\u524D", "\u6DF7\u4E71\u6642",
  "\u6210\u529F\u6642", "\u5931\u6557\u6642", "\u5BFE\u8C61\u8A0E\u4F10\u6642", "\u5473\u65B9\u8A0E\u4F10\u6642",
  "\u653B\u6483\u7D42\u4E86\u6642", "\u30B9\u30AD\u30EB\u7D42\u4E86\u6642", "\u30DE\u30C3\u30C1\u9032\u884C\u6642",
