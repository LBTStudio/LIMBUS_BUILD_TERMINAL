...
# Old tracked PDFs retained at sources/*.pdf for reference; corpus regenerated
# from sources/エラッタ最新版/*.pdf by extract_pdf_corpus.py.
SOURCES = {
...
def main(argv=None):
    ...
    parser.add_argument("--include-candidates", action="store_true", help="include source-derived records in JSON output")
